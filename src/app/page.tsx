      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-32 pb-16">
        ...
        <section id="home" className="mb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <div className="border border-green-400 p-3 sm:p-4 rounded text-center">
              <h3 className="text-red-400 text-xs sm:text-sm font-bold mb-2">EXPERIENCE</h3>
              <div className="text-xs sm:text-sm">
          ...
          <div className="border border-green-400 p-4 sm:p-6 rounded">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              ...
              >
                ...
                <span className="text-sm sm:text-base">linkedin.com/in/kushalkrishnappa</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-sm sm:text-base">github.com/kushalkrishnappa</span>
              </a>
            </div>
          </div>
        </section>
            ...
            {experiences.map((experience, index) => (
              <div key={index} className="border border-green-400 p-4 sm:p-6 rounded">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2">
                  <h2 className="text-lg sm:text-xl text-cyan-400">{experience.company}</h2>
                  <span className="text-sm sm:text-xl text-cyan-400">{experience.period}</span>
                </div>
                <p className="text-yellow-400 mb-4 text-sm sm:text-base">{experience.role}</p>
        ...
        <section id="projects" className="mb-24">
          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div key={index} className="border border-green-400 p-4 sm:p-6 rounded">
                <h2 className="text-lg sm:text-xl text-cyan-400 mb-2">{project.name}</h2>
                <p className="text-yellow-400 mb-4 text-sm sm:text-base">{project.description}</p>
        ...
        <section id="skills" className="mb-24">
          ...
          <div className="border border-green-400 p-4 sm:p-6 rounded">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl text-cyan-400 mb-4">Languages</h3>
                <ul className="space-y-1 text-xs sm:text-sm">
                  <li>• Python</li>
                  <li>• Java</li>
                  <li>• C/C++</li>
              ...
              <div>
                <h3 className="text-lg sm:text-xl text-cyan-400 mb-4">Technologies</h3>
                <ul className="space-y-1 text-xs sm:text-sm">
        ...
        <section className="mb-8">
          <div className="border border-yellow-400 p-4 sm:p-6 rounded bg-slate-800">
